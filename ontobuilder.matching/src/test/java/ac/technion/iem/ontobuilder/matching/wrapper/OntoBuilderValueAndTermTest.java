...
public class OntoBuilderNameTest extends TestCase {

    public void testMatchValues() throws OntoBuilderWrapperException {
        ...
        o2.addTerm(new Term("airplanes","B-52"));
        MatchInformation res = obw.matchOntologies(o1, o2, "Name Match");
        assertNotNull(res);
    }
}
