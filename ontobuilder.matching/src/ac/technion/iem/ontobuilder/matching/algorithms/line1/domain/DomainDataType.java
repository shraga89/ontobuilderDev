...
, DAY(new DaySniffer()),
MONTH(new MonthSniffer()),YEAR(new YearSniffer()), DATE(new DateSniffer()), MAIL(new MailSniffer()),
BOOLEAN(new BooleanSniffer()), CURRENCY(new CurrencySniffer()), PHONE(new PhoneSniffer()), DOUBLE(new DoubleSniffer());
