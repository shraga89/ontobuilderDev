...
/**
 * <p>Title: OntologyBIZFileFilter</p>
 * Extends {@link ExtensionFileFilter}
 */
public class OntologyBIZFileFilter extends ExtensionFileFilter
{
    /**
    ...
    {
        return ApplicationUtilities.getResourceString("file.ontologyBIZFilter.description");
    }
}
