...
/**
 * <p>Title: AbsoluteConstraints</p>
 * <p>Description: An object that encapsulates position and (optionally) size for Absolute positioning of
 * components</p>
...
public class AbsoluteConstraints implements Serializable
{
     ...
     * 
     * @param pos The position to be represented by this AbsoluteConstraints
     * @param size The size to be represented by this AbsoluteConstraints or null if the component's
     ...
     * @param x The X position to be represented by this AbsoluteConstraints
     * @param y The Y position to be represented by this AbsoluteConstraints
     * @param width The width to be represented by this AbsoluteConstraints or -1 if the component's
    ...
    /**
     * @return The width represented by this AbsoluteConstraints or -1 if the component's preferred
    ...
    /**
     * @return The height represented by this AbsoluteConstraints or -1 if the component's preferred
    ...
    {
        return super.toString() + " [x=" + x + ", y=" + y + ", width=" + width + ", height=" +
            height + "]";
    }
